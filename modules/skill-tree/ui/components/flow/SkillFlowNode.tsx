// modules/skill-tree/ui/components/flow/SkillFlowNode.tsx
// Custom React Flow node for skill tree topics
...
function SkillNodeComponent({ data }: NodeProps) {
  ...
  // Use Hebrew labels if RTL and available
  ...
  const targetPosition = isRtl ? Position.Right : Position.Left;
  const sourcePosition = isRtl ? Position.Left : Position.Right;
...
export const SkillFlowNode = memo(SkillNodeComponent);
